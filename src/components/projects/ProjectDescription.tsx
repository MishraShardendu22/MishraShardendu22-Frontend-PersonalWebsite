...
export function ProjectDescription({
  ...
  const markdownComponents = {
    ...
    h2: ({ children, className: _className, ...props }: any) => (
      <h2 className={cn('text-2xl font-semibold mb-3 mt-6 text-foreground', _className)} {...props}>
        {children}
      </h2>
    ),
    h3: ({ children, className: _className, ...props }: any) => (
      <h3 className={cn('text-xl font-semibold mb-2 mt-4 text-foreground', _className)} {...props}>
        {children}
      </h3>
    ),
    ...
    pre: ({ children, className: _className, ...props }: any) => (
      <pre className={cn('bg-muted p-4 rounded-lg overflow-x-auto mb-4', _className)} {...props}>
        {children}
      </pre>
    ),
