    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 flex items-center justify-center">
      <div className="flex flex-col items-center justify-center space-y-6">
        ...
        <div className="text-center space-y-2">
          <h2 className="text-xl font-heading text-foreground">Loading Certifications</h2>
          <p className="text-foreground">Fetching credentials and achievements...</p>
        </div>
      </div>
    </div>
  )
      ...
      <Card className="max-w-xl mx-auto border-2 border-dashed border-muted-foreground/25">
        <CardContent className="text-center py-12 space-y-6">
          ...
          <div className="space-y-2">
            <h3 className="text-lg font-heading text-foreground">No certifications found</h3>
