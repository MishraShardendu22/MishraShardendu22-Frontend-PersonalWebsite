...
const BlogPage = () => {
  ...
  return (
    <div className="space-y-10">
      <div className="mb-10">
        <div className="relative max-w-2xl mx-auto">
          ...
          <Input
            ...
            className="pl-14 pr-32 h-14 bg-card/60 backdrop-blur-sm border-border/60 focus:border-primary/40 hover:border-border focus:ring-2 focus:ring-primary/10 rounded-xl text-base text-foreground placeholder:text-muted-foreground transition-all duration-300 shadow-sm"
          />
          <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
            {loading && searchTerm ? (
              <div className="flex items-center gap-2 text-xs font-semibold text-muted-foreground bg-muted/80 px-3.5 py-2 rounded-lg border border-border/60 shadow-sm">
                <div className="w-3 h-3 border-2 border-primary/30 border-t-primary rounded-full animate-spin"></div>
                <span>Searching...</span>
              </div>
            ) : (
              <span className="text-xs font-semibold bg-primary/15 text-primary px-4 py-2 rounded-lg border border-primary/30 shadow-sm">
      ...
      {error && (
        <div className="mb-8 p-5 bg-destructive/10 border border-destructive/30 rounded-xl max-w-xl mx-auto shadow-sm">
      ...
      {loading && !showLoadingSkeleton && (
        <div className="mb-8 text-center">
          <div className="inline-flex items-center gap-2.5 text-sm text-muted-foreground bg-muted/30 px-4 py-2.5 rounded-full border border-border/50">
      ...
      {showLoadingSkeleton ? (
            ...
            >
              <div className="p-6 space-y-4">
                ...
                <div className="space-y-3">
                  <div className="h-6 w-5/6 bg-gradient-to-r from-muted/50 via-muted/30 to-muted/50 rounded animate-pulse" />
        ...
        <div className="text-center py-24">
          <div className="relative w-28 h-28 mx-auto mb-8">
            ...
            <div className="relative w-28 h-28 bg-gradient-to-br from-primary/20 via-primary/10 to-accent/5 rounded-3xl flex items-center justify-center shadow-xl border border-primary/10">
          ...
          {!searchTerm && isOwner && (
            <Button
              ...
              className="h-12 px-8 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold shadow-lg hover:shadow-xl shadow-primary/20 transition-all duration-300 gap-2.5 rounded-xl"
            >
