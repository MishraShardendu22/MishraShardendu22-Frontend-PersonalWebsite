          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <Select value={selectedYear} onValueChange={setSelectedYear}>
              <SelectTrigger className="w-[140px] h-9">
                <SelectValue placeholder="Latest Year" />
              </SelectTrigger>
              <SelectContent>
        ...
        <div className="container mx-auto px-6 py-8 max-w-full">
          ...
          <div className="flex items-center justify-between pt-6 border-t border-border/30 text-sm text-muted-foreground">
            <p>
              ...
              volunteer experiences (showing latest positions)
            </p>
            <p className="text-xs">Community service and volunteer leadership journey</p>
          </div>
        </div>
      </div>
    </div>
