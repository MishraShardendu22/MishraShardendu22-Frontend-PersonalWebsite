      ...
      <div className="grid gap-10 md:grid-cols-2">
        <Card className="bg-card/70 backdrop-blur-md border border-border rounded-xl shadow-lg hover:shadow-primary/20 transition-shadow">
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              <Label htmlFor="user-id" className="font-semibold text-sm text-foreground">
                User ID
              </Label>
              <Input
                id="user-id"
                ...
                disabled
                className="bg-muted text-foreground mt-1"
              />
            </div>

            <div>
              <Label htmlFor="admin-status" className="font-semibold text-sm text-foreground">
                Admin Status
              </Label>
              <div className="flex items-center gap-3 mt-1">
                <Input
